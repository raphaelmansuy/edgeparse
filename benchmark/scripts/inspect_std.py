#!/usr/bin/env python3
"""Inspect JSON for standard-heading docs."""
import json
import os
...
base_json = '/tmp/outstd'
base_gt = sys.argv[1] if len(sys.argv) > 1 else '/Users/raphaelmansuy/Github/03-working/edgeparse/benchmark/ground-truth/markdown'
docs = ['01030000000148', '01030000000164', '01030000000170', '01030000000172']
