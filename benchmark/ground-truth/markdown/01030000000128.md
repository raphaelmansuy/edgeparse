# Table and Figure from the Document
...
*Note: The figure shows the observed data, forecasted data, and the lower confidence bound over time.*
...
*Page 298 | Ch. 13. Homogeneous Investment Types*
