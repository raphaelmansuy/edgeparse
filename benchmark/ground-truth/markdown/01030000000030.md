...
If we now denote by N_LL, N_LH, N_NL and N_HH the number of paths of the indicated kinds, then with the above assumptions we also get the corresponding probability weights for the corresponding types as

P_LL = N_LL,  P_LH = pN_LH,  P_HL = pN_HL,  P_HH = p²N_HH.  (10)
