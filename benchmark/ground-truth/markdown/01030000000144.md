...
\[ M - Q(h) = c_p h^p + O(h^{p+1}), \quad (3.15a) \]
\[ M - Q(2h) = c_p (2)^p + O(h^{p+1}). \quad (3.15b) \]
...
\[ M = \frac{2^p Q(h) - Q(2h)}{2^p - 1} + O(h^{p+1}). \quad (3.16) \]

The value \( \frac{2^p Q(h) - Q(2h)}{2^p - 1} \) is a new approximation formula for \( M \) with an accuracy that is one order higher than the order of \( Q(h) \).
...
\[ f'(x) - Q_f(h) = c_1 h + O(h^2), \quad (3.17) \]

and the difference for \( 2h \) equals

\[ f'(x) - Q_f(2h) = c_1 2h + O(h^2). \quad (3.18) \]
