...
static PROFILES: &[(&str, &str, &[(&str, f64)])] = &[
    (
        "en",
        "English",
        &[
            ("the", 0.035), ("he ", 0.025), ("and", 0.020), ("ing", 0.018),
            ("tion", 0.015), ("er ", 0.014), ("ion", 0.013), (" th", 0.025),
            ("ed ", 0.012), ("in ", 0.012), ("to ", 0.011), (" to", 0.011),
            ("of ", 0.020), (" of", 0.018), ("ent", 0.010), ("is ", 0.010),
            (" is", 0.009), ("hat", 0.009), (" an", 0.012), ("nd ", 0.010),
        ],
    ),
    (
        "fr",
        "French",
        &[
            ("es ", 0.025), ("de ", 0.022), (" de", 0.022), ("le ", 0.018),
            ("ent", 0.017), (" le", 0.016), ("ion", 0.015), ("les", 0.014),
            ("la ", 0.013), (" la", 0.013), ("re ", 0.012), ("tion", 0.011),
            ("que", 0.013), (" qu", 0.011), ("ue ", 0.010), ("et ", 0.010),
            (" et", 0.009), ("des", 0.012), (" de", 0.022), ("ont", 0.009),
        ],
    ),
    (
        "de",
        "German",
        &[
            ("en ", 0.030), ("er ", 0.025), ("der", 0.018), ("die", 0.017),
            ("ein", 0.015), ("sch", 0.014), (" de", 0.016), ("ich", 0.014),
            ("und", 0.013), (" un", 0.012), ("nd ", 0.011), ("den", 0.010),
            ("che", 0.012), (" di", 0.013), ("ie ", 0.012), ("ung", 0.010),
            ("gen", 0.009), ("ine", 0.009), (" ei", 0.010), ("das", 0.008),
        ],
    ),
    (
        "es",
        "Spanish",
        &[
            ("de ", 0.025), (" de", 0.023), ("os ", 0.018), ("la ", 0.016),
            (" la", 0.015), ("en ", 0.015), ("el ", 0.014), (" el", 0.013),
            ("ión", 0.012), ("es ", 0.020), (" en", 0.012), ("ent", 0.010),
            ("que", 0.012), (" qu", 0.010), ("ue ", 0.009), ("aci", 0.008),
            ("ado", 0.008), ("las", 0.010), (" lo", 0.009), ("los", 0.010),
        ],
    ),
    (
        "it",
        "Italian",
        &[
            ("la ", 0.020), (" la", 0.018), (" di", 0.017), ("di ", 0.016),
            ("che", 0.015), ("re ", 0.014), ("ell", 0.013), ("lla", 0.012),
            ("to ", 0.011), ("ne ", 0.011), (" de", 0.012), ("del", 0.011),
            ("ent", 0.010), ("ion", 0.010), ("con", 0.009), (" co", 0.009),
            ("per", 0.009), (" pe", 0.008), ("ato", 0.008), ("ment", 0.007),
        ],
    ),
    (
        "pt",
        "Portuguese",
        &[
            ("de ", 0.025), (" de", 0.023), ("os ", 0.016), (" qu", 0.012),
            ("que", 0.012), ("ão ", 0.014), ("ção", 0.012), (" do", 0.010),
            ("do ", 0.010), ("da ", 0.011), (" da", 0.011), ("ent", 0.010),
            ("es ", 0.015), (" co", 0.009), ("com", 0.009), ("nte", 0.008),
            ("ment", 0.007), ("para", 0.007), (" pa", 0.007), (" no", 0.008),
        ],
    ),
];
